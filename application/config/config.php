...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : '029028fb57ad37f32281997724b97949';
...
$config['csrf_token_name'] = 'csrf_dgn_v1';
$config['csrf_cookie_name'] = 'csrf_cookie_dgn_v1';
